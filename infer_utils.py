...
def get_args():
    ...
    parser.add_argument('--image_folder', default=None, help='path to a folder of images for batch inference')
    parser.add_argument('--output', default=None, help='optional path to save results as a tab-separated .txt file')
    ...
    parser.add_argument('--model', default="vitstr_small_patch16_224_aug_infer.pth", help='ViTSTR model checkpoint path or URL')
    parser.add_argument('--TransformerModel', default='vitstr_small_patch16_224', help='ViTSTR architecture name (must match the checkpoint)')
